...
def run_inference(cfg: Config, ckpt_path: str = "unfold_ckpt.pt", rd_path: str = "Rd.mat"):
    ...
    print(f"\n[Inference]  Obj={obj:.4e}  PMUI={pm:.4e}  Radar={rd:.4e}")
    print(f"             SumRate={sr:.3f} b/s/Hz  ||X||²={pw:.4f}  (target={cfg.target_power:.4f})")
    return {"X": X, "U": U, "theta": theta, "traj": traj,
